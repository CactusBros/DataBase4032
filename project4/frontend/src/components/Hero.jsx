  ...
  return (
    <section className="relative w-full h-[75vh] overflow-hidden">
      ...
      <div className="relative h-full flex items-center justify-center text-right">
        <h1 className="text-5xl font-iran md:text-7xl lg:text-8xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-blue-900 to-blue-400 p-6 rounded-2xl">
          سامانه مدیریت پرواز و رزرو بلیط دانشگاه هرمزگان
        </h1>
      </div>
    </section>
  );
